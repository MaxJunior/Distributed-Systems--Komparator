package mediatorserver.ws.handler;
	...
	public boolean handleMessage(SOAPMessageContext smc) {
		...
		try {
			if (outboundElement.booleanValue()) {
				...
				// add header element value in this case the current Date
				String dateStrformatted = dateFormatter.format(new Date()).toString();
				
				System.out.println("Current DATE :" +dateStrformatted);
			//	int value = 22;
	      	//	String valueString = Integer.toString(value);
				element.addTextNode(dateStrformatted);
				...
				String dateStrformatted = element.getValue();
				System.out.println("Current DATE :" +dateStrformatted);
				Date sendedDate = dateFormatter.parse(dateStrformatted);
				...
				System.out.println("Header value is " + dateStrformatted);

				// put header in a property context
				smc.put(CONTEXT_PROPERTY,dateStrformatted);
